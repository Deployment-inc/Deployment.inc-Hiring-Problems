# Private submissions and contact
...
access only with this account unless Deployment.inc names another reviewer privately. Candidates
are never invited to a shared submission repository. Do not use public forks, issues, discussions
or pull requests to send work, results, contact details or credentials.

After saving, the form returns a submission ID. Keep it. Your entry and YAML are stored privately
in Cloudflare D1; there is no public submission list or response sheet. The ID confirms delivery,
not qualification or accepted GitHub access. A reviewer confirms access by email within ten
